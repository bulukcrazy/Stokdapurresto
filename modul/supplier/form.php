...
echo "<table width='100%'>
	<tr>
		<td>Kode Supplier</td>
		<td>:</td>
		<td><input type='text'  class='form-control col-sm-5' name='txt_kode' id='txt_kode'  size='10' lenght='10' class='input'></td>
	</tr>
	<tr>
		<td>Nama Supplier</td>
		<td>:</td>
		<td><input type='text' class='form-control col-sm-5' name='txt_nama' id='txt_nama'  size='50' lenght='50' class='input'></td>
	</tr>
	<tr>
		<td>Alamat</td>
		<td>:</td>
		<td><input type='text' class='form-control col-sm-5' name='txt_alamat' id='txt_alamat'  size='50' lenght='50' class='input'></td>
	</tr>
